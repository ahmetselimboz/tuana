            ...
            <div className='w-1/2 h-full flex items-center justify-center'>
                <div className='relative w-1/2 rounded-md shadow-xl border border-stone-900/20 flex flex-col px-4 pt-12 pb-2'>
                    ...
                    <div className='w-full flex flex-col items-center mb-4'>
                        <button className='lg:text-lg text-lg  text-main font-medium font-dosis tracking-wider px-16 py-1 border-2 border-primary rounded-md bg-primary hover:bg-secondary hover:border-secondary transition-all'>Reset Password</button>
                    </div>
