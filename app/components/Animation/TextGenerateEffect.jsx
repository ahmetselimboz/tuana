...
export const TextGenerateEffect = ({
  ...
  return (
    <div className={cn("font-bold ", className)} ref={ref}>
      <div className="mt-4 flex lg:flex-row flex-col   items-start justify-start">

        <div className="w-fit lg:mb-0 mb-2">
        ...
        <div className="dark:text-white lg:w-5/6 w-full rounded-tl-none bg-primary rounded-xl px-4 py-6 text-main text-base font-medium leading-snug tracking-wide">
          {renderWords()}
