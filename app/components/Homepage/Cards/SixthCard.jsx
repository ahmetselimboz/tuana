...
const SixthCard = () => {
    return (
        <div className='relative rounded-2xl shadow-xl border-4 border-primary w-full lg:h-full lg:min-h-[460px] min-h-[550px] bg-primary/5  flex flex-col justify-center p-4'>
            ...
            <div className='w-full h-auto items-center justify-center px-8 flex flex-col lg:text-justify text-center'>
                <div className='text-primaryGray font-semibold lg:text-5xl text-xl mb-5 flex items-center'>
                    <div className='text-primary inline-block mr-2'>Tuana </div> is your missing piece!
                </div>
