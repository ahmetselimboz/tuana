...
const FirstCard = () => {
    return (
        <div className='rounded-2xl shadow-xl border-4 border-primary w-full lg:h-full lg:min-h-[460px] min-h-[600px] bg-primary/5  flex lg:flex-row flex-col-reverse justify-center lg:p-4 py-6 px-8'>
            <div className='w-full lg:w-1/2 lg:h-full lg:items-start items-center justify-center lg:px-8 flex flex-col'>
                ...
                <div className='text-primaryGray font-base lg:text-1-5xl text-base'>
                    Your web or mobile platform is live. You’re excited to see users interact and engage with your work...
                </div>
            </div>
            <div className='w-full lg:w-1/2 lg:h-full flex items-center justify-center lg:p-12 overflow-hidden'>
                <div className='w-full h-full lg:mb-20 mb-8'>
                    <Image src="/cards/SecondCard.svg" alt="FirstCard" className="w-full " width="800" height="800" priority />
                </div>
            </div>
        </div>
    )
