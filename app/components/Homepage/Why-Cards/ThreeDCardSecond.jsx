...
export function ThreeDCardSecond() {
    ...
    return (
        (
            <>
                <SlideInFromLeft className='w-full h-full flex flex-col items-start justify-start px-16 py-8'>
                    <div className='text-primary font-semibold text-4xl mb-3 mt-5'>
                        Your Analytics Power is Always With You!
                    </div>
                    <div className='text-primaryGray text-2xl leading-snug tracking-wide mb-8'>
                    ...
                    <div className='w-full h-1/6 flex items-center justify-start lg:flex-row flex-col ml-4 lg:mb-0 '>
                ...
                <SlideInFromRight>
                    <CardContainer className="inter-var  ">
                        <CardBody
                            className=" relative h-[500px]  bg-transparent group/card flex items-center justify-center transition-all dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2]  w-auto sm:w-[30rem]  rounded-xl   ">
                            <Image
                                src="/Tuana_Phone.png"
                                height="1000"
                                width="1000"
